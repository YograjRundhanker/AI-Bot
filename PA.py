...
def wish_user():
    ...
    fun_talk("I am Smart-E: AI Bot. Tell me how may I help you.")
...
if True:
    ...
    while True: 
        ...
        if 'wikipedia' in query:
            ...
            fun_talk("I am Smart-E , developed by Vanshika. "
                        " as a project for self testing.")
            ...
            email_list = {
                'Yograj': 'yograj.rr@gmail.com',
                'Hemangi': 'hemangi.rr@gmail.com',
